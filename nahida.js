...
ppuser = 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60]'
     ...
     const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `N A H I D A - MD`,"body": `©𝐌𝐚𝐨𝐮 𝐀𝐫𝐟𝐢𝐧〆ᴀᴄᴍ`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/30f805bec7fcf80f6363a.jpg',"sourceUrl": ``}}}, { quoted:m})} 
...
m.reply(`𝐌𝐚𝐨𝐮𝐀𝐫𝐟𝐢𝐧〆ᴀᴄᴍ
SaY0uofficial
Nahida-MD ( title <Bot > )
𝐌𝐚𝐨𝐮 𝐀𝐫𝐟𝐢𝐧〆ᴀᴄᴍ ( codding )

Support by: 𝐌𝐚𝐨𝐮 𝐀𝐫𝐟𝐢𝐧〆ᴀᴄᴍ☉
...
reply('Bot Masih Mode *Perkembangan* Belum 100% Dan belum di rilis oleh Yt 𝐌𝐚𝐨𝐮 𝐀𝐫𝐟𝐢𝐧〆ᴀᴄᴍ Silahkan subscribe biar ga ke tinggalan Silahkan ketik command .credits untuk menampilkan credits dan .donasi untuk donasi.')
}
break
case 'antitoxic': {
if (!isGroup) return reply(`Hanya di Group`)
...
if (!isOwner) return reply(`Khusus Arfin Aja`)
...
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6287713626692`)
...
case 'pengguna':  {
if (!isCreator) return m.reply('*khusus Premium*')
if (!args[0]) return reply(`*Contoh : ${command} add 6287713626692*`)
if (args[1]) {
...
MORE...
====================================
VERSION : 1.0 || MADE BY 𝐌𝐚𝐨𝐮 𝐀𝐫𝐟𝐢𝐧〆ᴀᴄᴍ
====================================`
...
mediaType:  1,
mediaUrl: 'https://wa.me/6287713626692',
title: `Nahida-MD`,
sourceUrl: `https://wa.me/6287713626692`, 
thumbnail: thumb
}
}})
break
...
if (!isCreator) return m.reply('*Khusus Premium*')
await loading ()
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6287713626692@s.whatsapp.net`)
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 ...
 haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/30f805bec7fcf80f6363a.jpg' }, caption:`Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? Ketik tebak lagu`},{quoted:m}) 
 delete tebaklagu[m.sender.split('@')[0]]
 }
